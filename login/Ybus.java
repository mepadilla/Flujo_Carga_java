 ...
 * @author melvin
 */
public class Ybus  extends JPanel{
    ...
    private Matrix Bi[][] = null;
    private Matrix Bii[][] = null;
...
*/
                               		...
                               		while (rs3.next())
					{
						 realaux = Double.parseDouble(rs3.getString("resis"));
                                                ...
                                                imag3inv = imag3inv + auxcomplex.getImag();
                                        ...
                                        /* sentenciaybus = "INSERT INTO Ybus VALUES('"+1+"','" +(i+1)+"','"+(j+1)+"','" +real3inv +"','"+ imag3inv +"')";
                               		...
                               		while (rs4.next())
					{
						 realaux2 = Double.parseDouble(rs4.getString("resis"));
                                        ...
                                        /*sentenciaybus = "INSERT INTO Ybus VALUES('"+1+"','" +(i+1)+"','"+(j+1)+"','" +real5inv +"','"+ imag5inv +"')";
					 stmtybus = conx7.createStatement();
					 stmtybus.executeUpdate(sentenciaybus);
*/
			       ...
			       stmtybus.executeUpdate(sentenciaybus);
                        ...
                        model.addElement("La matriz Ybus Base es:");
                        model.addElement(" ");
			...
			catch(SQLException e2)
			{
				...
				JOptionPane.showMessageDialog(frame6,"No se pudo establecer conexi�n con la BD" + e2.getMessage());
                        ...
                        while (contador <= Itera && error >= Epsilon)
                        {
                            ...
                            model.addElement(" ");
                            model.addElement("Iteracion Gauss: " + contador);
                               		...
                               		while (rs8.next())
					{
                        ...
                        model.addElement(" ");
                        model.addElement("Resultados de La Iteracion. Gauss. ");
                        model.addElement(" ");
			...
			catch(SQLException e2)
			{
				...
				JOptionPane.showMessageDialog(frame6,"No se pudo establecer conexi�n con la BD" + e2.getMessage());
                        ...
                        while (contador <= Itera && error >= Epsilon)
                        {
                            ...
                            model.addElement(" ");
                            model.addElement("Iteracion Gauss-Seidel: " + contador);
                               		...
                               		while (rs8.next())
					{
                        ...
                        model.addElement(" ");
                        model.addElement("Resultados de La Iteracion. Gauss-Seidel. ");
                        model.addElement(" ");
                        model.addElement("Vector de Resultados ");
                        for (int x=0;x<nn5;x++)
                        {
                     ...
                     public void actionPerformed(ActionEvent e) {
                        ...
                        model.addElement(" ");
                        model.addElement("Newton-Rhapson");
                        model.addElement(" ");
			...
			Iterastr = "" + JOptionPane.showInputDialog("Ingrese El Maximo de Iteraciones Deseadas");
                        ...
                        JFrame frame6 = new JFrame();
                        JOptionPane.showMessageDialog(frame6,"Disculpe este modulo aun no esta disponible");
